                    ...
                    <div class="col-lg-10 offset-1" id="printr">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="row align-items-center">
                                <p class="fw-bold mt-2 invoice1" style="font-size: 50px;">Order History</p>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="tnx">Delivery Type</th>
                                    <th scope="col" class="tnx">Paid</th>
                                    <th scope="col" class="tnx">Amount</th>
                                    <th scope="col" class="tnx">Order Status</th>
                                </tr>
                            </thead>
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td  class="badge rounded-pill text-bg-warning ms-1 mt-2"> Delivered </td>
