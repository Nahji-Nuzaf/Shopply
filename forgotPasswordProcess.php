...
if(isset($_GET["e"])){
    ...
    if($row_nums == 1){
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'nahji2103842@gmail.com';
        $mail->Password = 'lrjq xabw pfrx fxnx';
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;
        $mail->setFrom('nahji2103842@gmail.com', 'Reset Password');
        $mail->addReplyTo('nahji2103842@gmail.com', 'Reset Password');
