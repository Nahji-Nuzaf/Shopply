                            ...
                            <div class="col-12 box1">
                                ...
                                <div class="row">
                                    <div class="col-12 ms-3">
                                        <p class="fw-bold mt-0 mb-0 ms-4" style="font-size: 30px;">Join Our Family Today.</p>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-12 text-center mt-4">
                                                    <span class="fw-bold" style="font-size:15px;">Already a Seller ? <a href="sellersignup.php" class="text-decoration-none text-primary">Get Access</a></span>
                                                </div>
